...
modules and SID files into MIDI + WAV. It is the bottom layer of **Remuxer** (see [../AGENTS.md](../AGENTS.md)):
...
so the dependency projects are built first — see [../../../AGENTS.md](../../../AGENTS.md) for the whole picture.
